...
export class EditDetailPersonComponent implements OnInit {
  constructor(
    ...
    private editservice: EditDetailService,
  ...
  emp = new FormGroup({
    ...
    ud_fullname_th: new FormControl('', [
      Validators.required,
      this.noWhitespaceValidator,
    ]),
    ud_fullname_en: new FormControl('', [
      Validators.required,
      this.noWhitespaceValidator,
    ]),
    ud_nickname: new FormControl('', [
      Validators.required,
      this.noWhitespaceValidator,
    ]),
    ud_birthday: new FormControl('', [Validators.required]),
    ud_id_card: new FormControl('', [
      Validators.required,
      this.noWhitespaceValidator,
    ]),
    ud_phone: new FormControl('', [
      Validators.required,
      this.noWhitespaceValidator,
    ]),
    ud_email: new FormControl(''),

    user_company: new FormControl('Exvention', [
      Validators.required,
      this.noWhitespaceValidator,
    ]),
    dept_name_en: new FormControl(null, [Validators.required]),
    user_contract_name: new FormControl(null, [
      Validators.required,
      this.noWhitespaceValidator,
    ]),
  ...
  Submit() {
    ...
    console.log(
      this.emp.controls.user_contract_name.invalid,
    ...
    let startdate = this.datepipe.transform(
      this.emp.controls.user_created_at.value,
      'YYYY-dd-MM'
    );
    let bthdate = this.datepipe.transform(
      this.emp.controls.user_created_at.value,
      'YYYY-dd-MM'
    );
    let enddate = null;
  ...
  ngOnInit() {
    ...
    this.dataService.getUserProfile(this.emp_id).subscribe({
      next: (res: any) => {
        ...
        this.emp.controls.user_contract_name.setValue(
          this.Objdata.user_contract_name
        );
        this.emp.controls.user_created_at.setValue(
          this.Objdata.user_created_at
        );
        ...
        this.emp.controls.user_take_annual_day.setValue(
          this.Objdata.user_take_annual_day
        );
        this.emp.controls.user_ordination_day.setValue(
          this.Objdata.user_ordination_day
        );
        this.emp.controls.user_military_service_day.setValue(
          this.Objdata.user_military_service_day
        );
        this.emp.controls.user_sterilization_day.setValue(
          this.Objdata.user_sterilization_day
        );
        this.emp.controls.user_maternity_day.setValue(
          this.Objdata.user_maternity_day
        );
        this.emp.controls.user_without_pay_day.setValue(
          this.Objdata.user_without_pay_day
        );
        this.emp.controls.user_resign_day.setValue(
          this.Objdata.user_resign_day
        );
  ...
  addInputDeptPosit() {
    ...
    console.log(
      Object.keys(this.Position[this.PositionCount.length - 1]).length === 0
    );
